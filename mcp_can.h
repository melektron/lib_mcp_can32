...
class MCP_CAN
{
    ...
    INT8S   MCPSCK;                                                     // SCK pin number
    INT8S   MCPMISO;                                                    // MISO pin number
    INT8S   MCPMOSI;                                                    // MOSI pin number
...
public:
    MCP_CAN(INT8U _CS, INT8S _SCK = -1, INT8S _MISO = -1, INT8S _MOSI = -1);           // Constructor for custom SCK, MISO, MOSI pins
